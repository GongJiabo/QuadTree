...
//    QuadTreeNode qqnode, qqtree;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        string fps = "FPS: " + to_string(static_cast<int>(1/deltaTime));
        ...
        glBindVertexArray(0);
        RenderText(textShader, fps, 10.0f, 10.0f, 0.50f, glm::vec3(0.5, 0.8f, 0.2f));
        RenderText(textShader, "(C) Map Based on QuadTree", 10.0f, 50.0f, 0.50f, glm::vec3(0.5, 0.8f, 0.2f));
